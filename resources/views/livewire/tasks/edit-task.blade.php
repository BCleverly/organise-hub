<div>
    <div class="max-w-2xl mx-auto">
        <div class="mb-8">
            <h1 class="text-2xl lg:text-3xl font-bold text-gray-900 dark:text-white">Edit Task</h1>
            <p class="text-sm lg:text-base text-gray-600 dark:text-neutral-400 mt-2">Update your task details.</p>
        </div>
