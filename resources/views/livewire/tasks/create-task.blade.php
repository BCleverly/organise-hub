<div>
    <div class="max-w-2xl mx-auto">
        <div class="mb-6">
            <h1 class="text-2xl lg:text-3xl font-bold text-gray-900">Create New Task</h1>
            <p class="text-sm lg:text-base text-gray-600 mt-1">Add a new task to your task manager.</p>
        </div>
