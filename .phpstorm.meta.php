...
'passkeys.redirect_to_after_login','passkeys.actions.generate_passkey_register_options','passkeys.actions.store_passkey','passkeys.actions.generate_passkey_authentication_options','passkeys.actions.find_passkey',
'passkeys.relying_party.name','passkeys.relying_party.id','passkeys.relying_party.icon','passkeys.models.passkey','passkeys.models.authenticatable',
...
'cashier.payment','cashier.webhook','sanctum.csrf-cookie','livewire.update','livewire.upload-file','livewire.preview-file','passkeys.authentication_options',
'passkeys.login','login','register','password.request','password.reset',
'dashboard','storage.local',);
        registerArgumentsSet('views', 
'components.layouts.app','components.layouts.guest','dashboard','livewire.auth.forgot-password','livewire.auth.login',
'livewire.auth.logout','livewire.auth.register','livewire.auth.reset-password','welcome','cashier::invoice',
'cashier::payment','laravel-exceptions-renderer::components.card','laravel-exceptions-renderer::components.context','laravel-exceptions-renderer::components.editor','laravel-exceptions-renderer::components.header',
...
'passkeys::components.authenticate','passkeys::components.partials.authenticateScript','passkeys::livewire.partials.createScript','passkeys::livewire.passkeys',);
...
'passkeys::.home.ben.Code.organise-hub.vendor.spatie.laravel-passkeys.resources.lang.zh_CN.passkeys.not_used_yet','passkeys::.home.ben.Code.organise-hub.vendor.spatie.laravel-passkeys.resources.lang.zh_CN.passkeys.passkeys',);
