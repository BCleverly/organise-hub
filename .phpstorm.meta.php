...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links./home/ben/Code/organise-hub/public/storage' => 'string',
            ...
            'passkeys.redirect_to_after_login' => 'string',
            'passkeys.actions.generate_passkey_register_options' => 'string',
            'passkeys.actions.store_passkey' => 'string',
            'passkeys.actions.generate_passkey_authentication_options' => 'string',
            'passkeys.actions.find_passkey' => 'string',
            'passkeys.relying_party.name' => 'string',
            'passkeys.relying_party.id' => 'string',
            'passkeys.relying_party.icon' => 'NULL',
            'passkeys.models.passkey' => 'string',
            'passkeys.models.authenticatable' => 'string',
            ...
            'reactions.table_name' => 'string',
            'reactions.reacts_model' => 'NULL',
            'reactions.reacts_id_column' => 'NULL',
...
'cache.stores.dynamodb.endpoint','cache.stores.octane.driver','cache.prefix','cashier.key','cashier.secret',
...
'cashier.logger','database.default','database.connections.sqlite.driver','database.connections.sqlite.url','database.connections.sqlite.database',
...
'filesystems.disks.s3.throw','filesystems.disks.s3.report','filesystems.links./home/ben/Code/organise-hub/public/storage','livewire.class_namespace','livewire.view_path',
...
'octane.cache.bytes','octane.watch','octane.garbage','octane.max_execution_time','passkeys.redirect_to_after_login',
'passkeys.actions.generate_passkey_register_options','passkeys.actions.store_passkey','passkeys.actions.generate_passkey_authentication_options','passkeys.actions.find_passkey','passkeys.relying_party.name',
'passkeys.relying_party.id','passkeys.relying_party.icon','passkeys.models.passkey','passkeys.models.authenticatable','permission.models.permission',
...
'tags.slugger','tags.tag_model','tags.taggable.table_name','tags.taggable.morph_name','tags.taggable.class_name',
...
'scramble.ui.try_it_credentials_policy','scramble.ui.layout','scramble.servers','scramble.enum_cases_description_strategy','scramble.middleware',
'scramble.extensions','boost.enabled','boost.browser_logs_watcher','reactions.table_name','reactions.reacts_model',
'reactions.reacts_id_column','eloquent-sortable.order_column_name','eloquent-sortable.sort_when_creating','eloquent-sortable.ignore_timestamps','personal-data-export.disk',
'personal-data-export.keep_directory_structure','personal-data-export.delete_after_days','personal-data-export.authentication_required','personal-data-export.notification','personal-data-export.job.queue',
'personal-data-export.job.connection','ide-helper.filename','ide-helper.models_filename','ide-helper.meta_filename','ide-helper.include_fluent',
...
'boost.browser-logs','cashier.payment','cashier.webhook','sanctum.csrf-cookie','livewire.update','livewire.upload-file','livewire.preview-file',
'passkeys.authentication_options','passkeys.login','login','register','password.request',
'password.reset','personal-data-exports','dashboard','tasks','tasks.create',
'tasks.edit','recipes','recipes.create','recipes.edit','recipes.show',
'preferences','storage.local','scramble.docs.ui','scramble.docs.document',);
        registerArgumentsSet('views', 
'components.application-logo','components.layouts.app','components.layouts.guest','components.task-card','dashboard',
'livewire.auth.forgot-password','livewire.auth.login','livewire.auth.logout','livewire.auth.register','livewire.auth.reset-password',
'livewire.dashboard','livewire.recipes','livewire.recipes.create-recipe','livewire.recipes.edit-recipe','livewire.recipes.recipe-detail',
'livewire.recipes.recipe-form','livewire.tasks','livewire.tasks.create-task','livewire.tasks.edit-task','livewire.user-preferences',
'passkeys::components.authenticate','passkeys::components.partials.authenticateScript','passkeys::livewire.partials.createScript','passkeys::livewire.passkeys','tasks',
'vendor.passkeys.components.authenticate','vendor.passkeys.components.partials.authenticateScript','vendor.passkeys.livewire.partials.createScript','vendor.passkeys.livewire.passkeys','welcome',
'cashier::invoice','cashier::payment','laravel-exceptions-renderer::components.card','laravel-exceptions-renderer::components.context','laravel-exceptions-renderer::components.editor',
...
'pagination::tailwind','passkeys::components.authenticate','passkeys::components.partials.authenticateScript','passkeys::livewire.partials.createScript','passkeys::livewire.passkeys',
'scramble::docs',);
...
'validation.url','validation.ulid','validation.uuid','validation.custom.attribute-name.rule-name','passkeys::.home.ben.Code.organise-hub.vendor.spatie.laravel-passkeys.resources.lang.ar.passkeys.authenticate_using_passkey',
'passkeys::.home.ben.Code.organise-hub.vendor.spatie.laravel-passkeys.resources.lang.ar.passkeys.create','passkeys::.home.ben.Code.organise-hub.vendor.spatie.laravel-passkeys.resources.lang.ar.passkeys.delete','passkeys::.home.ben.Code.organise-hub.vendor.spatie.laravel-passkeys.resources.lang.ar.passkeys.error_something_went_wrong_generating_the_passkey','passkeys::.home.ben.Code.organise-hub.vendor.spatie.laravel-passkeys.resources.lang.ar.passkeys.invalid','passkeys::.home.ben.Code.organise-hub.vendor.spatie.laravel-passkeys.resources.lang.ar.passkeys.last_used',
'passkeys::.home.ben.Code.organise-hub.vendor.spatie.laravel-passkeys.resources.lang.ar.passkeys.name','passkeys::.home.ben.Code.organise-hub.vendor.spatie.laravel-passkeys.resources.lang.ar.passkeys.name_placeholder','passkeys::.home.ben.Code.organise-hub.vendor.spatie.laravel-passkeys.resources.lang.ar.passkeys.no_passkeys_registered','passkeys::.home.ben.Code.organise-hub.vendor.spatie.laravel-passkeys.resources.lang.ar.passkeys.not_used_yet','passkeys::.home.ben.Code.organise-hub.vendor.spatie.laravel-passkeys.resources.lang.ar.passkeys.passkeys',
'passkeys::.home.ben.Code.organise-hub.vendor.spatie.laravel-passkeys.resources.lang.cz.passkeys.authenticate_using_passkey','passkeys::.home.ben.Code.organise-hub.vendor.spatie.laravel-passkeys.resources.lang.cz.passkeys.create','passkeys::.home.ben.Code.organise-hub.vendor.spatie.laravel-passkeys.resources.lang.cz.passkeys.delete','passkeys::.home.ben.Code.organise-hub.vendor.spatie.laravel-passkeys.resources.lang.cz.passkeys.error_something_went_wrong_generating_the_passkey','passkeys::.home.ben.Code.organise-hub.vendor.spatie.laravel-passkeys.resources.lang.cz.passkeys.invalid',
'passkeys::.home.ben.Code.organise-hub.vendor.spatie.laravel-passkeys.resources.lang.cz.passkeys.last_used','passkeys::.home.ben.Code.organise-hub.vendor.spatie.laravel-passkeys.resources.lang.cz.passkeys.name','passkeys::.home.ben.Code.organise-hub.vendor.spatie.laravel-passkeys.resources.lang.cz.passkeys.name_placeholder','passkeys::.home.ben.Code.organise-hub.vendor.spatie.laravel-passkeys.resources.lang.cz.passkeys.no_passkeys_registered','passkeys::.home.ben.Code.organise-hub.vendor.spatie.laravel-passkeys.resources.lang.cz.passkeys.not_used_yet',
'passkeys::.home.ben.Code.organise-hub.vendor.spatie.laravel-passkeys.resources.lang.cz.passkeys.passkeys','passkeys::.home.ben.Code.organise-hub.vendor.spatie.laravel-passkeys.resources.lang.de.passkeys.authenticate_using_passkey','passkeys::.home.ben.Code.organise-hub.vendor.spatie.laravel-passkeys.resources.lang.de.passkeys.create','passkeys::.home.ben.Code.organise-hub.vendor.spatie.laravel-passkeys.resources.lang.de.passkeys.delete','passkeys::.home.ben.Code.organise-hub.vendor.spatie.laravel-passkeys.resources.lang.de.passkeys.error_something_went_wrong_generating_the_passkey',
'passkeys::.home.ben.Code.organise-hub.vendor.spatie.laravel-passkeys.resources.lang.de.passkeys.invalid','passkeys::.home.ben.Code.organise-hub.vendor.spatie.laravel-passkeys.resources.lang.de.passkeys.last_used','passkeys::.home.ben.Code.organise-hub.vendor.spatie.laravel-passkeys.resources.lang.de.passkeys.name','passkeys::.home.ben.Code.organise-hub.vendor.spatie.laravel-passkeys.resources.lang.de.passkeys.name_placeholder','passkeys::.home.ben.Code.organise-hub.vendor.spatie.laravel-passkeys.resources.lang.de.passkeys.no_passkeys_registered',
'passkeys::.home.ben.Code.organise-hub.vendor.spatie.laravel-passkeys.resources.lang.de.passkeys.not_used_yet','passkeys::.home.ben.Code.organise-hub.vendor.spatie.laravel-passkeys.resources.lang.de.passkeys.passkeys','passkeys::.home.ben.Code.organise-hub.vendor.spatie.laravel-passkeys.resources.lang.en.passkeys.authenticate_using_passkey','passkeys::.home.ben.Code.organise-hub.vendor.spatie.laravel-passkeys.resources.lang.en.passkeys.create','passkeys::.home.ben.Code.organise-hub.vendor.spatie.laravel-passkeys.resources.lang.en.passkeys.delete',
'passkeys::.home.ben.Code.organise-hub.vendor.spatie.laravel-passkeys.resources.lang.en.passkeys.error_something_went_wrong_generating_the_passkey','passkeys::.home.ben.Code.organise-hub.vendor.spatie.laravel-passkeys.resources.lang.en.passkeys.invalid','passkeys::.home.ben.Code.organise-hub.vendor.spatie.laravel-passkeys.resources.lang.en.passkeys.last_used','passkeys::.home.ben.Code.organise-hub.vendor.spatie.laravel-passkeys.resources.lang.en.passkeys.name','passkeys::.home.ben.Code.organise-hub.vendor.spatie.laravel-passkeys.resources.lang.en.passkeys.name_placeholder',
'passkeys::.home.ben.Code.organise-hub.vendor.spatie.laravel-passkeys.resources.lang.en.passkeys.no_passkeys_registered','passkeys::.home.ben.Code.organise-hub.vendor.spatie.laravel-passkeys.resources.lang.en.passkeys.not_used_yet','passkeys::.home.ben.Code.organise-hub.vendor.spatie.laravel-passkeys.resources.lang.en.passkeys.passkeys','passkeys::.home.ben.Code.organise-hub.vendor.spatie.laravel-passkeys.resources.lang.es.passkeys.authenticate_using_passkey','passkeys::.home.ben.Code.organise-hub.vendor.spatie.laravel-passkeys.resources.lang.es.passkeys.create',
'passkeys::.home.ben.Code.organise-hub.vendor.spatie.laravel-passkeys.resources.lang.es.passkeys.delete','passkeys::.home.ben.Code.organise-hub.vendor.spatie.laravel-passkeys.resources.lang.es.passkeys.error_something_went_wrong_generating_the_passkey','passkeys::.home.ben.Code.organise-hub.vendor.spatie.laravel-passkeys.resources.lang.es.passkeys.invalid','passkeys::.home.ben.Code.organise-hub.vendor.spatie.laravel-passkeys.resources.lang.es.passkeys.last_used','passkeys::.home.ben.Code.organise-hub.vendor.spatie.laravel-passkeys.resources.lang.es.passkeys.name',
'passkeys::.home.ben.Code.organise-hub.vendor.spatie.laravel-passkeys.resources.lang.es.passkeys.name_placeholder','passkeys::.home.ben.Code.organise-hub.vendor.spatie.laravel-passkeys.resources.lang.es.passkeys.no_passkeys_registered','passkeys::.home.ben.Code.organise-hub.vendor.spatie.laravel-passkeys.resources.lang.es.passkeys.not_used_yet','passkeys::.home.ben.Code.organise-hub.vendor.spatie.laravel-passkeys.resources.lang.es.passkeys.passkeys','passkeys::.home.ben.Code.organise-hub.vendor.spatie.laravel-passkeys.resources.lang.fr.passkeys.authenticate_using_passkey',
'passkeys::.home.ben.Code.organise-hub.vendor.spatie.laravel-passkeys.resources.lang.fr.passkeys.create','passkeys::.home.ben.Code.organise-hub.vendor.spatie.laravel-passkeys.resources.lang.fr.passkeys.delete','passkeys::.home.ben.Code.organise-hub.vendor.spatie.laravel-passkeys.resources.lang.fr.passkeys.error_something_went_wrong_generating_the_passkey','passkeys::.home.ben.Code.organise-hub.vendor.spatie.laravel-passkeys.resources.lang.fr.passkeys.invalid','passkeys::.home.ben.Code.organise-hub.vendor.spatie.laravel-passkeys.resources.lang.fr.passkeys.last_used',
'passkeys::.home.ben.Code.organise-hub.vendor.spatie.laravel-passkeys.resources.lang.fr.passkeys.name','passkeys::.home.ben.Code.organise-hub.vendor.spatie.laravel-passkeys.resources.lang.fr.passkeys.name_placeholder','passkeys::.home.ben.Code.organise-hub.vendor.spatie.laravel-passkeys.resources.lang.fr.passkeys.no_passkeys_registered','passkeys::.home.ben.Code.organise-hub.vendor.spatie.laravel-passkeys.resources.lang.fr.passkeys.not_used_yet','passkeys::.home.ben.Code.organise-hub.vendor.spatie.laravel-passkeys.resources.lang.fr.passkeys.passkeys',
'passkeys::.home.ben.Code.organise-hub.vendor.spatie.laravel-passkeys.resources.lang.hu.passkeys.authenticate_using_passkey','passkeys::.home.ben.Code.organise-hub.vendor.spatie.laravel-passkeys.resources.lang.hu.passkeys.create','passkeys::.home.ben.Code.organise-hub.vendor.spatie.laravel-passkeys.resources.lang.hu.passkeys.delete','passkeys::.home.ben.Code.organise-hub.vendor.spatie.laravel-passkeys.resources.lang.hu.passkeys.error_something_went_wrong_generating_the_passkey','passkeys::.home.ben.Code.organise-hub.vendor.spatie.laravel-passkeys.resources.lang.hu.passkeys.invalid',
'passkeys::.home.ben.Code.organise-hub.vendor.spatie.laravel-passkeys.resources.lang.hu.passkeys.last_used','passkeys::.home.ben.Code.organise-hub.vendor.spatie.laravel-passkeys.resources.lang.hu.passkeys.name','passkeys::.home.ben.Code.organise-hub.vendor.spatie.laravel-passkeys.resources.lang.hu.passkeys.name_placeholder','passkeys::.home.ben.Code.organise-hub.vendor.spatie.laravel-passkeys.resources.lang.hu.passkeys.no_passkeys_registered','passkeys::.home.ben.Code.organise-hub.vendor.spatie.laravel-passkeys.resources.lang.hu.passkeys.not_used_yet',
'passkeys::.home.ben.Code.organise-hub.vendor.spatie.laravel-passkeys.resources.lang.hu.passkeys.passkeys','passkeys::.home.ben.Code.organise-hub.vendor.spatie.laravel-passkeys.resources.lang.nl.passkeys.authenticate_using_passkey','passkeys::.home.ben.Code.organise-hub.vendor.spatie.laravel-passkeys.resources.lang.nl.passkeys.create','passkeys::.home.ben.Code.organise-hub.vendor.spatie.laravel-passkeys.resources.lang.nl.passkeys.delete','passkeys::.home.ben.Code.organise-hub.vendor.spatie.laravel-passkeys.resources.lang.nl.passkeys.error_something_went_wrong_generating_the_passkey',
'passkeys::.home.ben.Code.organise-hub.vendor.spatie.laravel-passkeys.resources.lang.nl.passkeys.invalid','passkeys::.home.ben.Code.organise-hub.vendor.spatie.laravel-passkeys.resources.lang.nl.passkeys.last_used','passkeys::.home.ben.Code.organise-hub.vendor.spatie.laravel-passkeys.resources.lang.nl.passkeys.name','passkeys::.home.ben.Code.organise-hub.vendor.spatie.laravel-passkeys.resources.lang.nl.passkeys.name_placeholder','passkeys::.home.ben.Code.organise-hub.vendor.spatie.laravel-passkeys.resources.lang.nl.passkeys.no_passkeys_registered',
'passkeys::.home.ben.Code.organise-hub.vendor.spatie.laravel-passkeys.resources.lang.nl.passkeys.not_used_yet','passkeys::.home.ben.Code.organise-hub.vendor.spatie.laravel-passkeys.resources.lang.nl.passkeys.passkeys','passkeys::.home.ben.Code.organise-hub.vendor.spatie.laravel-passkeys.resources.lang.pt_BR.passkeys.authenticate_using_passkey','passkeys::.home.ben.Code.organise-hub.vendor.spatie.laravel-passkeys.resources.lang.pt_BR.passkeys.create','passkeys::.home.ben.Code.organise-hub.vendor.spatie.laravel-passkeys.resources.lang.pt_BR.passkeys.delete',
'passkeys::.home.ben.Code.organise-hub.vendor.spatie.laravel-passkeys.resources.lang.pt_BR.passkeys.error_something_went_wrong_generating_the_passkey','passkeys::.home.ben.Code.organise-hub.vendor.spatie.laravel-passkeys.resources.lang.pt_BR.passkeys.invalid','passkeys::.home.ben.Code.organise-hub.vendor.spatie.laravel-passkeys.resources.lang.pt_BR.passkeys.last_used','passkeys::.home.ben.Code.organise-hub.vendor.spatie.laravel-passkeys.resources.lang.pt_BR.passkeys.name','passkeys::.home.ben.Code.organise-hub.vendor.spatie.laravel-passkeys.resources.lang.pt_BR.passkeys.name_placeholder',
'passkeys::.home.ben.Code.organise-hub.vendor.spatie.laravel-passkeys.resources.lang.pt_BR.passkeys.no_passkeys_registered','passkeys::.home.ben.Code.organise-hub.vendor.spatie.laravel-passkeys.resources.lang.pt_BR.passkeys.not_used_yet','passkeys::.home.ben.Code.organise-hub.vendor.spatie.laravel-passkeys.resources.lang.pt_BR.passkeys.passkeys','passkeys::.home.ben.Code.organise-hub.vendor.spatie.laravel-passkeys.resources.lang.pt_PT.passkeys.authenticate_using_passkey','passkeys::.home.ben.Code.organise-hub.vendor.spatie.laravel-passkeys.resources.lang.pt_PT.passkeys.create',
'passkeys::.home.ben.Code.organise-hub.vendor.spatie.laravel-passkeys.resources.lang.pt_PT.passkeys.delete','passkeys::.home.ben.Code.organise-hub.vendor.spatie.laravel-passkeys.resources.lang.pt_PT.passkeys.error_something_went_wrong_generating_the_passkey','passkeys::.home.ben.Code.organise-hub.vendor.spatie.laravel-passkeys.resources.lang.pt_PT.passkeys.invalid','passkeys::.home.ben.Code.organise-hub.vendor.spatie.laravel-passkeys.resources.lang.pt_PT.passkeys.last_used','passkeys::.home.ben.Code.organise-hub.vendor.spatie.laravel-passkeys.resources.lang.pt_PT.passkeys.name',
'passkeys::.home.ben.Code.organise-hub.vendor.spatie.laravel-passkeys.resources.lang.pt_PT.passkeys.name_placeholder','passkeys::.home.ben.Code.organise-hub.vendor.spatie.laravel-passkeys.resources.lang.pt_PT.passkeys.no_passkeys_registered','passkeys::.home.ben.Code.organise-hub.vendor.spatie.laravel-passkeys.resources.lang.pt_PT.passkeys.not_used_yet','passkeys::.home.ben.Code.organise-hub.vendor.spatie.laravel-passkeys.resources.lang.pt_PT.passkeys.passkeys','passkeys::.home.ben.Code.organise-hub.vendor.spatie.laravel-passkeys.resources.lang.sk.passkeys.authenticate_using_passkey',
'passkeys::.home.ben.Code.organise-hub.vendor.spatie.laravel-passkeys.resources.lang.sk.passkeys.create','passkeys::.home.ben.Code.organise-hub.vendor.spatie.laravel-passkeys.resources.lang.sk.passkeys.delete','passkeys::.home.ben.Code.organise-hub.vendor.spatie.laravel-passkeys.resources.lang.sk.passkeys.error_something_went_wrong_generating_the_passkey','passkeys::.home.ben.Code.organise-hub.vendor.spatie.laravel-passkeys.resources.lang.sk.passkeys.invalid','passkeys::.home.ben.Code.organise-hub.vendor.spatie.laravel-passkeys.resources.lang.sk.passkeys.last_used',
'passkeys::.home.ben.Code.organise-hub.vendor.spatie.laravel-passkeys.resources.lang.sk.passkeys.name','passkeys::.home.ben.Code.organise-hub.vendor.spatie.laravel-passkeys.resources.lang.sk.passkeys.name_placeholder','passkeys::.home.ben.Code.organise-hub.vendor.spatie.laravel-passkeys.resources.lang.sk.passkeys.no_passkeys_registered','passkeys::.home.ben.Code.organise-hub.vendor.spatie.laravel-passkeys.resources.lang.sk.passkeys.not_used_yet','passkeys::.home.ben.Code.organise-hub.vendor.spatie.laravel-passkeys.resources.lang.sk.passkeys.passkeys',
'passkeys::.home.ben.Code.organise-hub.vendor.spatie.laravel-passkeys.resources.lang.tr.passkeys.authenticate_using_passkey','passkeys::.home.ben.Code.organise-hub.vendor.spatie.laravel-passkeys.resources.lang.tr.passkeys.create','passkeys::.home.ben.Code.organise-hub.vendor.spatie.laravel-passkeys.resources.lang.tr.passkeys.delete','passkeys::.home.ben.Code.organise-hub.vendor.spatie.laravel-passkeys.resources.lang.tr.passkeys.error_something_went_wrong_generating_the_passkey','passkeys::.home.ben.Code.organise-hub.vendor.spatie.laravel-passkeys.resources.lang.tr.passkeys.invalid',
'passkeys::.home.ben.Code.organise-hub.vendor.spatie.laravel-passkeys.resources.lang.tr.passkeys.last_used','passkeys::.home.ben.Code.organise-hub.vendor.spatie.laravel-passkeys.resources.lang.tr.passkeys.name','passkeys::.home.ben.Code.organise-hub.vendor.spatie.laravel-passkeys.resources.lang.tr.passkeys.name_placeholder','passkeys::.home.ben.Code.organise-hub.vendor.spatie.laravel-passkeys.resources.lang.tr.passkeys.no_passkeys_registered','passkeys::.home.ben.Code.organise-hub.vendor.spatie.laravel-passkeys.resources.lang.tr.passkeys.not_used_yet',
'passkeys::.home.ben.Code.organise-hub.vendor.spatie.laravel-passkeys.resources.lang.tr.passkeys.passkeys','passkeys::.home.ben.Code.organise-hub.vendor.spatie.laravel-passkeys.resources.lang.zh_CN.passkeys.authenticate_using_passkey','passkeys::.home.ben.Code.organise-hub.vendor.spatie.laravel-passkeys.resources.lang.zh_CN.passkeys.create','passkeys::.home.ben.Code.organise-hub.vendor.spatie.laravel-passkeys.resources.lang.zh_CN.passkeys.delete','passkeys::.home.ben.Code.organise-hub.vendor.spatie.laravel-passkeys.resources.lang.zh_CN.passkeys.error_something_went_wrong_generating_the_passkey',
'passkeys::.home.ben.Code.organise-hub.vendor.spatie.laravel-passkeys.resources.lang.zh_CN.passkeys.invalid','passkeys::.home.ben.Code.organise-hub.vendor.spatie.laravel-passkeys.resources.lang.zh_CN.passkeys.last_used','passkeys::.home.ben.Code.organise-hub.vendor.spatie.laravel-passkeys.resources.lang.zh_CN.passkeys.name','passkeys::.home.ben.Code.organise-hub.vendor.spatie.laravel-passkeys.resources.lang.zh_CN.passkeys.name_placeholder','passkeys::.home.ben.Code.organise-hub.vendor.spatie.laravel-passkeys.resources.lang.zh_CN.passkeys.no_passkeys_registered',
'passkeys::.home.ben.Code.organise-hub.vendor.spatie.laravel-passkeys.resources.lang.zh_CN.passkeys.not_used_yet','passkeys::.home.ben.Code.organise-hub.vendor.spatie.laravel-passkeys.resources.lang.zh_CN.passkeys.passkeys','personal-data-export::.home.ben.Code.organise-hub.vendor.spatie.laravel-personal-data-export.resources.lang.en.notifications.subject','personal-data-export::.home.ben.Code.organise-hub.vendor.spatie.laravel-personal-data-export.resources.lang.en.notifications.instructions','personal-data-export::.home.ben.Code.organise-hub.vendor.spatie.laravel-personal-data-export.resources.lang.en.notifications.action',
'personal-data-export::.home.ben.Code.organise-hub.vendor.spatie.laravel-personal-data-export.resources.lang.en.notifications.deletion_message',);
...
'CASHIER_CURRENCY','CASHIER_CURRENCY_LOCALE','STRIPE_KEY','STRIPE_SECRET','STRIPE_WEBHOOK_SECRET',);
